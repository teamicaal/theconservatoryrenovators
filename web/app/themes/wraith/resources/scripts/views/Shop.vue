...
<template>
  <div class="bg-white">
    <div class="max-w-2xl mx-auto pt-4 pb-6 px-1 sm:px-1-5 lg:max-w-7xl lg:px-2">
      ...
      <form class="mt-3 lg:grid lg:grid-cols-12 lg:gap-x-3 lg:items-start xl:gap-x-4">
          ...
          <ul role="list" class="border-t border-b border-gray-200 divide-y divide-gray-200">
            <li v-for="(product, productIdx) in products" :key="product.id" class="flex py-1-5 sm:py-2">
              <div class="flex-shrink-0">
                <img :src="product.imageSrc" :alt="product.imageAlt" class="w-24 h-24 rounded-md object-center object-cover sm:w-12 sm:h-12" />
              </div>

              <div class="ml-4 flex-1 flex flex-col justify-between sm:ml-1-5">
        ...
        <section aria-labelledby="summary-heading" class="mt-4 bg-gray-50 rounded-lg px-1 py-1-5 sm:p-1-5 lg:p-2 lg:mt-0 lg:col-span-5">
          ...
          <div class="mt-1-5">
            <button type="submit" class="w-full bg-primary border border-transparent rounded-md shadow-sm py-0-75 px-1 text-base font-medium text-white hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500">Checkout</button>
          </div>
        </section>
      </form>
    </div>
