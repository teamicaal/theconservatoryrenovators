...
<section class="md:px-2">
  <div class="bg-grey-lightest pt-4 pb-2 md:pt-6 md:pb-4 lg:pt-8 lg:pb-6">
    <div class="container mx-auto px-0 lg:px-1 text-center">
      ...
      @if( have_rows('pages') )
      <div class="flex lg:flex-wrap lg:justify-center scroll-x-proximity overflow-x-scroll lg:overflow-hidden lg:-mx-1">
          ...
          @if( $page )
            <div class="w-16 lg:w-1/3 mb-1 px-1 scroll-align-start mb-2" style="flex: 0 0 auto;">
              <a href="{{ get_the_permalink($page->ID) }}" class="embed embed-4by3 rounded-sm mb-1">
                <img data-src="{{ get_the_post_thumbnail_url($page->ID) }}" src="" alt="{!! $custom_title ? $custom_title : $page->title; !!}" class="lozad object-cover" />
              </a>
