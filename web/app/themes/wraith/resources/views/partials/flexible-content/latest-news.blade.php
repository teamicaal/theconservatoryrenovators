          ...
          <article class="w-full lg:w-1/2 p-1">
            <div class="w-full flex flex-col sm:flex-row py-1-5 relative h-full" style="border-top: 1px solid #f7f7f7;">
              ...
              <div class="w-full sm:w-1/3 md:mr-1 relative" style="min-height: 200px;">
                <img data-src="{!! get_the_post_thumbnail_url() !!}" src="{!! get_the_post_thumbnail_url('lozad') !!}" width="100%" height="auto" alt="{!! the_title(); !!}" class="lozad object-cover-absolute w-full h-full absolute">
              </div>
            </div>
          </article>
        @endwhile
