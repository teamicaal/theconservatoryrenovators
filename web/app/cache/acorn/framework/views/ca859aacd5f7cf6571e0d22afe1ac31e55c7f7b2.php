...
<section id="form-landing" class="py-4 lg:py-8 <?php echo e($colour_bg ? 'bg-primary' : 'bg-white'); ?>">
  <div class="container mx-auto">
      <div class="flex flex-wrap lg:flex-row-reverse">
          <div class="w-full lg:w-2/3 lg:pl-4 xl:pl-0">

              <div class="bg-gray-100 h-auto w-full xl:w-3/4 ml-auto h-full pl-2 pr-1 py-2">
                <form class="conversion-form h-full" method="post">
                  ...
                  <?php  $i=0; ?>
                  <?php if(have_rows('form_steps')): ?>
                    <?php while(have_rows('form_steps')): ?>
                    <?php
                      the_row();
                      $i++;
                      $title = get_sub_field('title');
                    ?>
                      <div class="form-pane<?php echo e($i == 1 ? ' active' : null); ?>">
                        <div class="flex flex-wrap mb-2 pr-1">
                          <div class="w-3/5">
                            <h2 class="text-xl font-medium md:text-3xl mb-0"><?php echo e($title); ?></h2>
                          </div>
                          <div class="w-2/5 flex items-center justify-end">
                            <div class="bg-white rounded-lg">
                              <span class="py-1 px-1 md:px-2 text-md block font-bold text-gray-800 text-sm md:text-base">STEP <?php echo e($i); ?></span>
                            </div>
                          </div>
                        </div>
                        <div class="">
                          <div class="flex flex-wrap">
                            <?php
                              ...
                              $j = 0;
                            ?>
                            <?php while(have_rows('form_options')): ?>
                            <?php
                              the_row();
                              $j++;
                            ...
                            ?>
                              <div class="w-full sm:w-1/2">
                                <div class="form-pane-option <?php echo $j == $count_form_options ? null : 'mb-2 sm:mb-1' ?> px-2 py-1 md:py-1-5 text-left bg-white mb-2 sm:mb-1 mr-1 border-primary rounded-lg border border-gray-dark hover:border-primary cursor-pointer" data-name="step_<?php echo e($i); ?>" data-value="<?php echo e($label); ?>" data-pane="<?php echo e($i); ?>">
                                  <h5 class="mb-0 lg:text-xl text-lg"><?php echo e($label); ?></h5>
                  ...
                  <?php endif; ?>
                    ...
                    <div class="form-pane<?php echo e(have_rows('form_steps') ? null : ' active'); ?> h-full">
                      <div class="flex flex-wrap items-center mb-2 pr-1">
                        ...
                        <div class="w-2/5 flex items-center justify-end">
                          <div class="bg-white rounded-lg">
                            <span class="py-1 px-1 md:px-2 text-md block font-bold text-gray-800 text-sm md:text-base">STEP <?php echo e($i + 1); ?></span>
                          </div>
                        </div>
                      </div>
                      <div class="">
                        <div class="mb-2 py-1 px-1 sm:px-2 mr-1">
                          ...
                          <div class="w-full lg:w-2/3 mx-auto">
                            <input class="postcode-input w-full rounded border border-gray-dark p-1 rounded-md" type="text" name="postcode" placeholder="Postcode" >
                            <h6 class="postcode-response text-red-500 text-sm mb-0 mt-1"></h6>
                          </div>
                        </div>
                        <div class="pr-1">
                    ...
                    <div class="form-pane h-full">
                      <div class="flex flex-wrap items-center mb-2 pr-1">
                        ...
                        <div class="w-2/5 flex items-center justify-end">
                          <div class="bg-white rounded-lg">
                            <span class="py-1 px-1 md:px-2 text-md block font-bold text-gray-800 text-sm md:text-base">FINAL STEP</span>
                          </div>
                        </div>
                      </div>
                      <div class="">
                        <div class="mb-1 pr-1">
                          <div class="">
                            <input class="w-full rounded border border-gray-dark p-1 rounded-md mb-1 details-input" type="text" name="first_name" placeholder="First Name">
                            <input class="w-full rounded border border-gray-dark p-1 rounded-md mb-1 details-input" type="text" name="last_name" placeholder="Last Name">
                            <input class="w-full rounded border border-gray-dark p-1 rounded-md mb-1 details-input" type="email" name="email" placeholder="Email">
                            <input class="w-full rounded border border-gray-dark p-1 rounded-md details-input" type="tel" name="phone" placeholder="Phone Number">
                          </div>
                          <h6 class="details-response mb-0 text-red-500 text-sm"></h6>
                        </div>
                        <div class="pr-1">
                          <div class="flex justify-between items-center mb-1">
                            <h6 class="text-gray-600 mb-0 text-sm"><svg class="fill-current inline-block" enable-background="new 0 0 24 24" height="16px" width="16px" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m18.75 9h-.75v-3c0-3.309-2.691-6-6-6s-6 2.691-6 6v3h-.75c-1.24 0-2.25 1.009-2.25 2.25v10.5c0 1.241 1.01 2.25 2.25 2.25h13.5c1.24 0 2.25-1.009 2.25-2.25v-10.5c0-1.241-1.01-2.25-2.25-2.25zm-10.75-3c0-2.206 1.794-4 4-4s4 1.794 4 4v3h-8zm5 10.722v2.278c0 .552-.447 1-1 1s-1-.448-1-1v-2.278c-.595-.347-1-.985-1-1.722 0-1.103.897-2 2-2s2 .897 2 2c0 .737-.405 1.375-1 1.722z"/></svg> Your information is data protected.</h6>
                    ...
                    <div class="form-pane h-full">
                      <div class="flex flex-wrap items-center mb-2 pr-1">
                        ...
                        <div class="w-2/5 flex items-center justify-end">
                          <div class="bg-white rounded-lg">
                            <span class="py-1 px-1 md:px-2 text-md block font-bold text-gray-800 text-sm md:text-base">THANK YOU</span>
                          </div>
                        </div>
                      </div>
                      <div class="pr-1">
                        <p>The team at <?php echo get_bloginfo( 'name' ); ?> appreciate you taking the time to contact us. One of our friendly and knowledgeable advisors will be in touch with you as soon as possible to provide our very best quote.</p>
                        <p>We look forward to speaking to you soon,</p>
                        <p>The <?php echo get_bloginfo( 'name' ); ?> team.</p>
                      </div>
                    </div>
          ...
          <div class="w-full lg:w-1/3 flex items-center mt-3 lg:mt-0">
            <div class="">
              <h1 class="font-bold mb-1 text-3xl lg:text-5xl<?php echo e($colour_bg ? ' text-white' : null); ?>"><?php echo e($landing_title); ?></h1>
              <h3 class="text-xl mb-0 <?php echo e($colour_bg ? 'text-white' : 'text-gray-800'); ?>"><?php echo e($subtitle); ?></h3>
...
<?php /**PATH /Users/mattpickles/Local Sites/wraith/web/app/themes/wraith/resources/views/partials/flexible-content-landing/form-landing.blade.php ENDPATH**/ ?>