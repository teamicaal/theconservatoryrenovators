...
<section class="section_products<?php echo $custom_class ? ' ' . $custom_class : ' md:pt-24 md:pb-20 pt-20 pb-16'; ?>">
  <div class="container mx-auto">
    <h2 class="text-center text-4xl mb-8"><?php echo $title; ?></h2>
    <?php if(have_rows('product_types')): ?>
      <div class="text-center flex items-center justify-start md:justify-center w-full overflow-x-auto mb-14">
        <?php while(have_rows('product_types')): ?>
        <?php
          the_row();
          $i++;
          $title = get_sub_field('title');
        ?>
          <button class="btn bg-gray-100 mixitup-control flex-[0_0_auto] mb-0-75 <?php echo $i == 1 ? 'mixitup-control-active' : null; ?> text-black mx-1" type="button" data-filter=".<?php echo e(strtolower(str_replace(',-', ' ', str_replace(' ', '-', $title)))); ?>"><?php echo $title; ?></button>
        <?php endwhile; ?>
      </div>
          ...
          <div class="products px-4 sm:px-0">
            <div class="flex flex-wrap -mx-4">
              <?php if(have_rows('products')): ?>
                ...
                ?>
                  <div class="lg:w-1/3 sm:w-1/2 w-full sm:px-4 mb-8 mix <?php echo e(strtolower(str_replace(',-', ' ', str_replace(' ', '-', $title)))); ?>">
                    <a class="group" href="#contact-us">
                      <div class="relative isolate">
                        <div class="embed-4by3">
                          <img data-src="<?php echo e($image['sizes']['4by3-md']); ?>" alt="<?php echo e($image['alt']); ?>" class="lozad object-fit-cover" />
                        </div>
                        <div class="w-11/12 mx-auto mt-[-2.5rem] p-5 bg-gray-100 flex justify-between items-center rounded-sm relative z-10 transition group-hover:bg-primary">
                          <p class="text-lg text-black mb-0 transition group-hover:text-white"><?php echo $label; ?></p>
...
<?php /**PATH /Users/nick/Local/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/products.blade.php ENDPATH**/ ?>