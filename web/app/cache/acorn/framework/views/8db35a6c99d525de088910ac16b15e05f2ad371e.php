                ...
                <div class="flex items-center">
                  <div style="width: 66px;">
                    <div class="embed embed-7by10 bg-gray-dark">
                      <img data-src="<?php if( $thumbnail ): ?> <?php echo e($thumbnail['url']); ?> <?php else: ?> <?= \Roots\asset('images/document-placeholder.jpg'); ?> <?php endif; ?>" class="lozad object-cover" width="66" height="auto" />
                    </div>
                  </div>
                  <div class="p-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mattpickles/Local Sites/wraith/web/app/themes/wraith/resources/views/archive-download.blade.php ENDPATH**/ ?>