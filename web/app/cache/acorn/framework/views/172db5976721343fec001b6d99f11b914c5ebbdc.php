              ...
              <form>
                ...
                <div class="flex flex-wrap">
                  ...
                  <div class="w-full mb-4">
                    ...
                    <input name="card_number" type="number" pattern="\d*" maxlength="16" placeholder="xxxx xxxx xxxx xxxx" class="input-text">
                  </div>
                  <div class="w-full md:w-1/2 mb-4 md:pr-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mattpickles/Local Sites/wraith/web/app/themes/wraith/resources/views/template-checkout.blade.php ENDPATH**/ ?>