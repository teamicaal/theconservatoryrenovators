        ...
        <?php while( have_rows('pages') ): ?>
          ...
          <?php if( $page ): ?>
            <div class="w-64 lg:w-1/3 mb-4 px-4 snap-center mb-8" style="flex: 0 0 auto;">
              <a href="<?php echo e(get_the_permalink($page->ID)); ?>" class="embed embed-4by3 rounded-sm overflow-hidden mb-4">
...
<?php /**PATH /Users/mattpickles/Local Sites/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/page-links-simple.blade.php ENDPATH**/ ?>