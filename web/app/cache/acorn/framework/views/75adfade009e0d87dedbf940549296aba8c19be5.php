    ...
    <div class="flex flex-wrap mix-container">
      ...
      <?php $i++; ?>
        <div class="w-1/2 lg:w-1/3 mb-1 px-8 gallery-image item fb-gallery mix <?php echo e(str_replace(' ', '-', strtolower($image['caption']))); ?>">
          <a href="<?php echo e($image['url']); ?>" title="<?php echo e($image['title']); ?> ?>" rel="gallery-page" class="embed-4by3 rounded-sm overflow-hidden" data-fancybox="gallery" data-fancybox-group itemprop="contentUrl" data-size="<?php echo e($image['width']); ?>x<?php echo e($image['height']); ?>" data-index="<?php echo e($i); ?>">
...
<?php /**PATH /Users/nick/Local/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/gallery-page.blade.php ENDPATH**/ ?>