  ...
  <div class="container mx-auto">
      ...
      <div class="flex flex-wrap justify-center">
        <?php if( get_sub_field('features') ): ?>
          <?php $count = count(get_sub_field('features')); ?>
        <?php endif; ?>
...
<?php /**PATH /Users/nick/Local/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/key-features.blade.php ENDPATH**/ ?>