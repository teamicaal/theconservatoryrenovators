				...
				<?php if( $image ): ?>
					<div class="w-full lg:w-1/2">
						<div class="embed-4by3 rounded-sm overflow-hidden">
							<img data-src="<?php echo e($image['url']); ?>" alt="<?php echo e($image_alt ? $image_alt : $image['alt']); ?>" class="lozad object-fit-cover w-full h-full inset-0">
						</div>
					</div>
				<?php endif; ?>
...
</section><?php /**PATH /Users/nick/Local/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/alternating-content.blade.php ENDPATH**/ ?>