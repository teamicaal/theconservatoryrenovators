...
<section id="form-landing" class="py-16 lg:py-32 <?php echo e($coloured_bg ? 'bg-primary' : 'bg-white'); ?>">
  <div class="container mx-auto">
    <div class="flex flex-wrap lg:flex-row-reverse lg:items-center">
      <div class="w-full lg:w-2/3 lg:pl-4 xl:pl-0">
        ...
        <div class="bg-gray-100 rounded-sm h-auto w-full xl:w-3/4 ml-auto h-full py-4 pl-4 lg:py-8 lg:pl-8 lg:pr-4">
          <form class="conversion-form h-full" method="post">
              ...
              <?php while(have_rows('form_steps')): ?>
                ...
                <div class="form-pane<?php echo e($i == 1 ? ' active' : null); ?>">
                  <div class="flex flex-wrap mb-8 pr-4">
                    <div class="w-3/5">
                      <h2 class="text-xl font-medium md:text-3xl mb-0"><?php echo e($step_title); ?></h2>
                    </div>
                    <div class="w-2/5 flex items-center justify-end">
                      <div class="bg-white rounded-sm">
                        <span class="py-4 px-4 md:px-8 text-md block font-bold text-gray-800 text-sm md:text-base">STEP <?php echo e($i); ?></span>
                      </div>
                    </div>
                  </div>
                  <?php
                    ...
                    $ii = 0;
                  ?>
                  <?php if( have_rows('step_options') ): ?>
                    <div class="flex flex-wrap">
                      <?php while(have_rows('step_options')): ?>
                        <?php
                          the_row();
                          $ii++;
                        ...
                        <div class="w-full sm:w-1/2">
                          <div class="form-pane-option<?php echo e($ii == $count_step_options ? null : ' mb-4'); ?> px-8 py-4 md:py-6 text-left bg-white mr-4 border-2 border-gray-200 rounded-sm hover:border-gray-500 transition cursor-pointer" data-name="step_<?php echo e($i); ?>" data-value="<?php echo e($label); ?>" data-pane="<?php echo e($i); ?>">
            ...
            <div class="form-pane h-full<?php echo e($custom_step ? null : ' active'); ?>">
              <div class="flex flex-wrap items-center mb-8 pr-4">
                ...
                <div class="w-2/5 flex items-center justify-end">
                  <div class="bg-white rounded-sm">
                    <span class="py-4 px-4 md:px-8 text-md block font-bold text-gray-800 text-sm md:text-base">STEP <?php echo e($i + 1); ?></span>
                  </div>
                </div>
              </div>
              <div class="">
      ...
      <div class="w-full lg:w-1/3 mt-12 lg:mt-0">
        <h1 class="font-bold mb-4 text-3xl lg:text-5xl<?php echo e($coloured_bg ? ' text-white' : null); ?>"><?php echo e($title); ?></h1>
        <h3 class="text-xl mb-0 <?php echo e($coloured_bg ? 'text-white' : 'text-gray-800'); ?>"><?php echo e($subtitle); ?></h3>
        ...
        <ul class="list-none py-0 px-0 mt-8">
          ...
          ?>
          <li class="mb-4 text-lg flex items-center <?php echo e($coloured_bg ? 'text-white' : 'text-gray-900'); ?>">
            <span class="mr-1 <?php echo e($coloured_bg ? 'text-white' : 'text-primary'); ?>"><svg xmlns="http://www.w3.org/2000/svg" class="fill-current" width="25px" height="25px" viewBox="0 -21 512.016 512" width="512pt">
                <path
...
</script><?php /**PATH /Users/mattpickles/Local Sites/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/form-conversion.blade.php ENDPATH**/ ?>