          ...
          <div class="w-full flex flex-col sm:flex-row py-6 relative h-full">
            ...
            <div class="w-full sm:w-1/3 md:mr-4">
              <div class="embed-4by3 rounded-sm overflow-hidden">
                <img data-src="<?= get_the_post_thumbnail_url(get_the_ID(), '4by3-md'); ?>" src="<?= get_the_post_thumbnail_url(get_the_ID(), 'lozad'); ?>" width="100%" height="auto" alt="<?= get_the_title(); ?>" class="lozad object-fit-cover">
              </div>
            </div>
          </div>
        </article>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nick/Local/wraith/web/app/themes/wraith/resources/views/home.blade.php ENDPATH**/ ?>