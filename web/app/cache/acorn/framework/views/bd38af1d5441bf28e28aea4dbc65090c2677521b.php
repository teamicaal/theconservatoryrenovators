          ...
          <article class="w-full lg:w-1/2 p-4">
            <div class="w-full flex flex-col sm:flex-row py-6 relative h-full">
              ...
              <div class="w-full sm:w-1/3 md:mr-4 relative rounded-sm overflow-hidden" style="min-height: 200px;">
                <img data-src="<?= get_the_post_thumbnail_url(get_the_ID(), 'thumbnail'); ?>" src="<?= get_the_post_thumbnail_url(get_the_ID(), 'lozad'); ?>" width="100%" height="auto" alt="<?= get_the_title(); ?>" class="lozad object-cover-absolute w-full h-full absolute">
              </div>
            </div>
          </article>
...
<?php /**PATH /Users/mattpickles/Local Sites/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/latest-news.blade.php ENDPATH**/ ?>