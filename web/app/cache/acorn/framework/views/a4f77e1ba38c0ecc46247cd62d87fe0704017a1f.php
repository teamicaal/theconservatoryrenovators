...
<section class="section_quoting-engine<?php echo $custom_class ? ' ' . $custom_class : ' md:py-24 py-20'; ?>">
  <div class="container mx-auto">
    <div class="lg:w-3/5 w-full mx-auto text-center flex flex-col items-center">
      <?php echo $title ? '<h2 class="text-4xl mb-6">' . $title . '</h2>' : null; ?>
...
<script>
  (function($) {
    var engine = $('#engine-container').Engine('<?php echo $qe_key; ?>', {
...
<?php /**PATH /Users/nick/Local/wraith/web/app/themes/wraith/resources/views/partials/flexible-content/quoting-engine.blade.php ENDPATH**/ ?>